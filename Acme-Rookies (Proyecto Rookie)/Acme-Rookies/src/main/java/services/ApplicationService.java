...
public class ApplicationService {
	...
	public Collection<Application> findByPrincipalCompany(final int id) {
		final Collection<Application> result = this.applicationRepository.findByPrincipalCompany(id);
		return result;
	}
