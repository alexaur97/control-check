...
<form:form action="remark/company/edit.do" modelAttribute="remark">
<form:hidden path="id" />
...
<acme:submit name="delete" code="remark.delete"/>
<acme:cancel url="remark/company/show.do?remarkId=${remark.id}" code="remark.cancel" />
</form:form>
