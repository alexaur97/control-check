...
<div>
	<ul id="jMenu">
		...
		<security:authorize access="hasRole('AUDITOR')">
			<li><a href="audit/auditor/myList.do"><spring:message
		...
		<security:authorize access="hasRole('COMPANY')">
			...
			<li><a class="fNiv" href="remark/company/list.do"><spring:message
						code="master.page.remarks" /></a></li>
		</security:authorize>

		<security:authorize access="hasRole('ROOKIE')">
			<li><a class="fNiv" href="remark/rookie/list.do"><spring:message
						code="master.page.remarks" /></a></li>
		</security:authorize>
		...
		<security:authorize access="isAuthenticated()">
			<li><a class="fNiv"> <spring:message
				...
				<ul>
					...
					<security:authorize
						access="hasAnyRole('ROOKIE','COMPANY','PROVIDER','AUDITOR')">
